...
public class Util {
    ...
    public static String readAsset(String assetName, String defaultS) {
        try {
            InputStream is = TravelApp.getAppResources().getAssets().open(assetName);
    ...
    public static String getValue(String string, int defaultId)
    {
        return (string != null && string.length() > 0) ?
                string : TravelApp.getAppContext().getString(defaultId);
    }
    ...
    public static int convertPxToDp(int px) {
        WindowManager wm = (WindowManager)TravelApp.getAppContext().
    ...
    public static int convertDpToPx(int dp) {
        return Math.round(
                ...
                TravelApp.getAppResources().getDisplayMetrics())
                         );
    }
...
//        }
    ...
    public static boolean isPhone(){
        TelephonyManager manager = (TelephonyManager)TravelApp.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
