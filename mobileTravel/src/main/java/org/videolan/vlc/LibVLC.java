...
public class LibVLC {
    ...
    public String getSubtitlesEncoding() {
        final SharedPreferences p = PreferenceManager.getDefaultSharedPreferences(TravelApp.getAppContext());
    ...
    public boolean timeStretchingEnabled() {
        SharedPreferences p = PreferenceManager.getDefaultSharedPreferences(TravelApp.getAppContext());
    ...
    private void init() throws LibVlcException {
        ...
        if (!mIsInitialized) {
            ...
            Context context = TravelApp.getAppContext();
            SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
