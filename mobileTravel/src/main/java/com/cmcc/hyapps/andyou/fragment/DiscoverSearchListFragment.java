 ...
 */
public class DiscoverSearchListFragment extends BaseFragment implements /*DataLoader.DataLoaderCallback<QHScenic.QHScenicList>, */View.OnClickListener {
    ...
    private void initPullToRefresh() {
        ...
        mPullToRefreshView.setOnRefreshListener(new OnRefreshListener<RecyclerView>() {
            ...
            public void onRefresh(PullToRefreshBase<RecyclerView> refreshView) {
                if (refreshView.getCurrentMode() == Mode.DISABLED) {
                    reload();
                } else {
