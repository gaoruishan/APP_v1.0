...
public class DownloadManager {
     ...
     * completes.
     */
    public final static String ACTION_DOWNLOAD_COMPLETE = "com.cmcc.hyapps.andyou.intent.action.DOWNLOAD_COMPLETE";

    /**
     * Broadcast intent action sent by the download manager.
     * information.
     */
    public final static String ACTION_DOWNLOAD_INFORMATION = "com.cmcc.hyapps.andyou.intent.action.DOWNLOAD_INFORMATION";
    ...
    public final static String ACTION_NOTIFICATION_CLICKED =
            "com.cmcc.hyapps.andyou.intent.action.DOWNLOAD_NOTIFICATION_CLICKED";

    /**
     * Intent action to launch an activity to display all downloads.
     */
    public final static String ACTION_VIEW_DOWNLOADS = "com.cmcc.hyapps.andyou.intent.action.VIEW_DOWNLOADS";
