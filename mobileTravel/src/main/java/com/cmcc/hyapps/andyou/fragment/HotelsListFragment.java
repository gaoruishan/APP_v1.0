...
public class HotelsListFragment extends BaseFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MarketHotelsListAdapter(getActivity());
        ...
        mPullToRefreshView.setOnRefreshListener(new OnRefreshListener<RecyclerView>() {
            ...
            public void onRefresh(PullToRefreshBase<RecyclerView> refreshView) {
                if (refreshView.getCurrentMode() == Mode.PULL_FROM_START) {
                    ...
                    //下拉加载
                    mLoader.loadMoreQHData(HotelsListFragment.this, DataLoader.MODE_LOAD_MORE);
                }
