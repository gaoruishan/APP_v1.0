...
import com.cmcc.hyapps.andyou.adapter.MarketSpecialListAdapter;
...
public class SpecialListFragment extends BaseFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MarketSpecialListAdapter(getActivity());
    ...
    private void loadList(){
        ...
        mLoader.setUrl(ServerAPI.SpecialList.URL);
    }
        ...
        mPullToRefreshView.setOnRefreshListener(new OnRefreshListener<RecyclerView>() {
            ...
            public void onRefresh(PullToRefreshBase<RecyclerView> refreshView) {
                if (refreshView.getCurrentMode() == Mode.PULL_FROM_START) {
                    ...
                    //下拉加载
                    mLoader.loadMoreQHData(SpecialListFragment.this, DataLoader.MODE_LOAD_MORE);
                }
