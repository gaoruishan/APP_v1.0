 ...
 */
public class HotelDetailsActivity extends BaseActivity implements View.OnClickListener,ViewPager.OnPageChangeListener {
    private TextView hotelName,hotelTel,hotelPrice,hotelLocation,hotelFavorbale,hotelArgumentNumber,hotelDescription;
    ...
    private void getQhMarketShopDetail(){
       String url = ServerAPI.MarketShopList.URL + hotelDeatil.id +"/";
        marketShopLoader = RequestManager.getInstance().sendGsonRequest(Request.Method.GET, url, QHMarketShop.class, null, new Response.Listener<QHMarketShop>() {
            ...
            public void onResponse(QHMarketShop response) {
                hotelArgumentNumber.setText("评论(" + String.valueOf(response.comment_count) + ")");
            }
