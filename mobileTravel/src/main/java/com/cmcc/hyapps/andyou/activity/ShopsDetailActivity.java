 ...
 * @author kuloud
 */
public class ShopsDetailActivity extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    private TextView mRestName, mRestTel, mAverage,mRestPrice, mRestLocation, mRestFavorbale, mRestArgumentNumber, mRestDescription;
    ...
    private void getQhMarketShopDetail() {
        String url = ServerAPI.MarketShopList.URL + mId+"/";
        marketShopLoader = RequestManager.getInstance().sendGsonRequest(Request.Method.GET, url, QHMarketShop.class, null, new Response.Listener<QHMarketShop>() {
            ...
            public void onResponse(QHMarketShop response) {
                ...
                if (response.stype != 4){
                    mRestPrice.setVisibility(View.VISIBLE);
...
//                    ToastUtils.show(ShopsDetailActivity.this,R.string.delete_information);
//                }
            }
        }, false, requestTag);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mId = getIntent().getIntExtra(Const.QH_SECNIC_ID, 0);
//        getmLocation();
        initView();
...
//        initData();
    ...
    private void initView() {
        ...
        mRestPrice.setVisibility(View.INVISIBLE);
...
//                        ImageLoader.getImageListener(netImg, R.drawable.bg_image_hint,
//                                R.drawable.bg_image_hint));

                ImageUtil.DisplayImage(url, netImg, R.drawable.bg_image_hint,
                        R.drawable.bg_image_hint);
            }
