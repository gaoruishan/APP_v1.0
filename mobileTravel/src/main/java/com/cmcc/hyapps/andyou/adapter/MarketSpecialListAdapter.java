...
public class MarketSpecialListAdapter extends AppendableAdapter<QHMarketShop> {
    private Activity mContext;

    public MarketSpecialListAdapter(Activity context) {
        this.mContext = context;
    }

    public MarketSpecialListAdapter(Activity context, List<QHMarketShop> items) {
        this(context);
