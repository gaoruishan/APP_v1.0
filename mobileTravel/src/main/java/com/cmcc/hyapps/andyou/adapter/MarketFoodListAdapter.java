...
public class MarketFoodListAdapter extends AppendableAdapter<QHMarketShop> {
    private Activity mContext;

    public MarketFoodListAdapter(Activity context) {
        this.mContext = context;
    }

    public MarketFoodListAdapter(Activity context, List<QHMarketShop> items) {
        this(context);
