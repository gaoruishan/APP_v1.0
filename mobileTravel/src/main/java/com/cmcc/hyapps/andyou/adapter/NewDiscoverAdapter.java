...
public class NewDiscoverAdapter extends BaseHeaderAdapter<Tag.TagList, QHScenic> {
    ...
    public NewDiscoverAdapter(Activity context, List<QHScenic> items) {
        this(context);
        this.mDataItems = items;

    }

    public NewDiscoverAdapter(Context activity, BannerPagerAdapter.IActionCallback<Tag> actionCallback) {
        this(activity);
    ...
    public ViewHolder onCreateHeaderViewHolder(ViewGroup parent) {
        ...
        LinearLayout ll=(LinearLayout)v.findViewById(R.id.discover_tags_ll);
        //ToastUtils.show(mContext, "执行了吗");
        if (mHeader!=null&&mHeader.results!=null) if (mHeader.results.size() > 0) {
...
//                layoutParams.setMargins(scap_Mar,10,10,10);
    ...
    private  void setTextView(Context context,int j,LinearLayout ll){
        ...
        int scap_Mar = ScreenUtils.dpToPxInt(context, 10);
...
//
//                    });
//            viewHolder.netImage.setImageUrl(scenic.image_url,
...
//            viewHolder.netImage.setDefaultImageResId(R.drawable.recommand_bg);
            ...
            ImageUtil.DisplayImage(scenic.image_url, viewHolder.netImage);
...
//            viewHolder.netImage.setDefaultImageResId(R.color.transparency);
        ...
        attachClickListener(viewHolder, viewHolder.netImage, position);
   ...
   static class DiscoverHeaderViewHolder extends ViewHolder {
    ...
    class DiscoverViewHolder extends ViewHolder {
