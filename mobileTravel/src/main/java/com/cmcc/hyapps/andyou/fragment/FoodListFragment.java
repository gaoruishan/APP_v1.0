...
import com.cmcc.hyapps.andyou.adapter.MarketFoodListAdapter;
...
public class FoodListFragment extends BaseFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MarketFoodListAdapter(getActivity());
    ...
    private void loadList(){
        ...
        mLoader.setUrl(ServerAPI.RestaurantList.URL);
    }
        ...
        mPullToRefreshView.setOnRefreshListener(new OnRefreshListener<RecyclerView>() {
            ...
            public void onRefresh(PullToRefreshBase<RecyclerView> refreshView) {
                if (refreshView.getCurrentMode() == Mode.PULL_FROM_START) {
                    ...
                    //下拉加载
                    mLoader.loadMoreQHData(FoodListFragment.this, DataLoader.MODE_LOAD_MORE);
                }
