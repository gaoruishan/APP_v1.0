...
public class NewPhotoPreviewActivity extends BaseActivity implements ZoomImageView.OnPhotoTapListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mImageData = getIntent().getStringArrayListExtra(Const.EXTRA_IMAGE_DATA);
//                getParcelableArrayListExtra(Const.EXTRA_IMAGE_DATA);
        ...
        setContentView(R.layout.activity_newphoto_preview);
    //    initActionBar();
...
//        mInfoTime = ((TextView) findViewById(R.id.image_info_time));
        ...
        startIndex = intent.getIntExtra(Const.EXTRA_IMAGE_PREVIEW_START_INDEX, 0);
    ...
    private void loadImageAtIndex(int index) {
        ...
        String image = mImageData.get(index);
        ZoomImageView imageView = (ZoomImageView) itemView.findViewById(R.id.image);
        imageView.setOnPhotoTapListener(NewPhotoPreviewActivity.this);
...
//        }
        ...
        if (image!= null) {
            ...
            ImageUtil.DisplayImage(image, imageView);
//            imageView.setImageUrl(image, RequestManager.getInstance().getImageLoader());
//            imageView.setDefaultImageResId(R.drawable.recommand_bg);
